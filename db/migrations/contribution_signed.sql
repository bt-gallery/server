...
SELECT DISTINCT contribution.id,
                ...
                participant.team
FROM contribution
JOIN participant ON contribution.id_participant = participant.id
JOIN specification ON participant.specification = specification.id